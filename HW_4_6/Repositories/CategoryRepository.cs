...
public sealed class CategoryRepository : ICategoryRepository
{
    ...
    /// <summary>
    /// Used to update category entry in the database.
    /// </summary>
    /// <param name="entity">Category entity to update a database entry.</param>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
    ...
    /// <summary>
    /// Used to delete category entry from the database.
    /// </summary>
    /// <param name="entity">Category entity to update a database entry.</param>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation.</returns>
